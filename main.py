...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # پکیج 5 گیگ
        ...
        await q.message.reply_text(
            "💰 مبلغ ۸۰ هزار تومان را به شماره کارت زیر به نام امیررضا هژبر واریز کنید:\n\n"
            "6104338644728640\n\n"
    ...
    # پکیج 10 گیگ
        ...
        await q.message.reply_text(
            "💰 مبلغ ۱۲۰ هزار تومان را به شماره کارت زیر به نام امیررضا هژبر واریز کنید:\n\n"
            "6104338644728640\n\n"
            "بعد از پرداخت رسید را ارسال کنید 🌹"
        )
    ...
    # پکیج 20 گیگ
        ...
        await q.message.reply_text(
            "💰 مبلغ ۲۰۰ هزار تومان را به شماره کارت زیر به نام امیررضا هژبر واریز کنید:\n\n"
            "6104338644728640\n\n"
            "بعد از پرداخت رسید را ارسال کنید 🌹"
        )
